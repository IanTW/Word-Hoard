...
- [FSRS, not SM-2](fsrs-not-sm2.md): the scheduler, with learning steps in front of it, and why py-fsrs over a from-scratch build.
...
- [Local-only git, no remote](local-only-git-no-remote.md): skip the Wrap Up push step.
