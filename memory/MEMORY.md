...
- [Vertical slice first](vertical-slice-first.md): SATISFIED 2026-09-08, the slice is in real use; the lasting rule is let use raise the work.
...
- [User data is NO LONGER disposable](user-data-is-disposable-for-now.md): EXPIRED 2026-09-08, the user is now studying; never reset the db, never write test reviews to it.
- [Git remote and push](git-remote-and-push.md): pushes to IanTW/Word-Hoard on main; the Wrap Up push step applies.
